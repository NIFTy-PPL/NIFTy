...
def make_adjust_variances_hamiltonian(a,
    ...
    position : :class:`nifty.field.Field`, :class:`nifty.multi_field.MultiField`
        Contains the initial values for the operators a and xi, to be adjusted
    samples : :class:`nifty.field.Field`, :class:`nifty.multi_field.MultiField`
    ...
    Returns
    -------
    :class:`nifty.operators.energy_operators.StandardHamiltonian`
...
def do_adjust_variances(position, A, minimizer, xi_key='xi', samples=[]):
    ...
    samples : :class:`nifty.field.Field`, :class:`nifty.multi_field.MultiField`, optional
