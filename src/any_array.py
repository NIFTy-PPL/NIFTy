...
class AnyArray(np.lib.mixins.NDArrayOperatorsMixin):
    ...
    def ptw(self, op, *args, **kwargs):
        ...
        the corresponding function from :mod:`nifty8.pointwise`.
    ...
    # ---Printing functions---
    def __repr__(self):
        return f"<nifty8.AnyArray: device_id={self._device_id}>"

    def __str__(self):
        return "\n".join(["nifty8.AnyArray instance",
