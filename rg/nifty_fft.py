...
fft_module_name = global_configuration['fft_module']
fft_module = global_dependency_injector[fft_module_name]
...
if fft_module_name == 'pyfftw':
    ...
    class _fftw_plan_and_info(object):
        ...
        def compute_plan_and_info(self, domain, codomain, fft_fftw_context,
            ...
            self.fftw_local_size = fft_module.local_size(
    ...
    class fft_gfft(fft):
        ...
        def transform(self, val, domain, codomain, **kwargs):
            ...
            if(domain.datatype == np.float64):
                temp = fft_module.gfft(temp.astype(np.complex128),
                                       in_ax=[],
                                       out_ax=[],
                                       ftmachine=ftmachine,
