...
def trans(*, sky_before, sky_after):
    ...
    return lambda sample_list: ift.full(sky_after.domain, 0.0)
...
def test_optimize_kl_cfg_save_and_load():
    cfg = ift.OptimizeKLConfig.from_file(
        "demos/old_nifty/getting_started_7_config_file.cfg", builder_dct
    )
