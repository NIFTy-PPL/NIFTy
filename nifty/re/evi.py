...
def draw_linear_residual(
    ...
    *,
    ...
    # geovidoc Alg. 1: return (1 + (A^T A)(primals))∙tangents
    ...
    # geovidoc Alg. 1:  nll_smpl = A^T η_2
    nll_smpl = sample_likelihood(lh, p_liquid, key=subkey_nll)

    # geovidoc Alg. 1: prr_inv_metric_smpl = η_1
    ...
    if from_inverse:
        ...
        # geovidoc Alg. 1: smpl = (1 + (A^T A)(p_liquid))⁻¹∙smpl
...
def nonlinearly_update_residual(    # geovidoc Alg. 1 - implementation
    ...
    *,
    ...
    # geovidoc Alg. 1: residual_vg(...) = Energy(ξ̄ , (dx/dξ̄)(ξ̄̄), z, ξ̄)
    def residual_vg(e, lh_trafo_at_p, ms_at_p, x):
        ...
        # geovidoc Alg. 1 Line 8: t = x(ξ̄) - x(ξ̄̄)
        t = tree_map(jnp.subtract, lh.transformation(x), lh_trafo_at_p)
        # geovidoc Alg. 1 Line 8: g = A^T(x(ξ̄) - x(ξ̄̄))
    ...
    # geovidoc Alg. 1 Line 3 - 5: z = metric_sample
    ...
    if not skip:
        ...
        # geovidoc Alg. 1 Line 10: opt_state = NewtonCG(Energy, ξ^0)
