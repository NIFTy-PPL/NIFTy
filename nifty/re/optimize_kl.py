    ...
    def draw_samples(
        ...
        **kwargs,
        ...
        if sample_mode.lower() in (
            ...
            # geovidoc Alg. 1 Line 6 - initialization of ξ with linear sol.
            ...
            if sample_mode.lower().startswith("nonlinear"):
                # geovidoc Alg. 1 - update samples via Alg. 1
...
def optimize_kl(
    ...
    *,
    ...
    nm = "OPTIMIZE_KL"
    # the geovidoc commments refer to the pseudocode in the geovi paper: 
    # https://doi.org/10.48550/arXiv.2105.10470
    # geovidoc Alg. 2: outer loop Line 4-20
    for i in range(opt_vi_st.nit, opt_vi.n_total_iterations):
        logger.info(f"{nm}: Starting {i + 1:04d}")
        # geovidoc Alg. 2: core Algorithm Line 5-19
