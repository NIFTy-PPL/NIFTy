...
class _2dFigure(_BaseFigure):
    ...
    def _to_plotly(self):
        ...
        if self.xaxis:
            ...
            ply_object['layout']['scene']['aspectratio']['x'] = self.xaxis.aspectRatio
        if self.yaxis:
            ply_object['layout']['yaxis'] = self.yaxis._to_plotly()
            ply_object['layout']['scene']['aspectratio']['y'] = self.yaxis.aspectRatio
        return ply_object
...
class _3dFigure(_2dFigure):
    ...
    def _to_plotly(self):
        ...
        if self.zaxis:
            ...
            ply_object['layout']['scene']['aspectratio']['z'] = self.zaxis.aspectRatio
        return ply_object
